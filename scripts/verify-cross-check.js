...
assertContains(webHtml, "태권도 품새 수련인을 위한 영상 기반 AI 분석 코치 · v3.37", "헤더 설명 문구 적용");
...
assertContains(webHtml, "active_range_valley_natural_segments_length_proportional_allocation", "valley 자연 구간 + 길이비례 동작배분 적용");
