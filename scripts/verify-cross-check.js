...
assertContains(webHtml, "태권도 품새 수련인을 위한 영상 기반 AI 분석 코치 · v3.22", "헤더 설명 문구 적용");
...
assertContains(readUtf8(path.join(root, "www", "service-worker.js")), "poomsae-training-v2-hakdari-geumgang", "학다리서기 금강막기 아이콘 캐시 버전 적용");
...
assertContains(webHtml, "skeleton-angle-kta-cross-validation-revision-6-", "스켈레톤 관절각 및 KTA 교차검증 방식과 민감도를 캐시 키에 반영");
...
assertContains(webHtml, "video.duration * 5", "구간 감지를 초당 5회 수준으로 강화");
...
assertContains(webHtml, "제작: 울산 몸가짐운동센터</p>\n          <p>제작자: 김동규 센터장", "제작자 정보를 한 줄 아래에 표시");
assertContains(webHtml, "0507-1366-0466</a></p>\n          <img class=\"app-footer-partners\"", "새 로고를 몸가짐운동센터 내용 바로 아래에 표시");
