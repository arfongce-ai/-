...
assertContains(webHtml, "태권도 품새 수련인을 위한 영상 기반 AI 분석 코치 · v3.57", "헤더 설명 문구 적용");
...
assertContains(readUtf8(path.join(root, "www", "service-worker.js")), "poomsae-training-v10-taegeuk1-stance-table", "www 직접 배포용 오프라인 엔진 캐시 적용");
...
assertContains(readUtf8(rootServiceWorkerPath), "poomsae-training-root-offline-engine-v8-taegeuk1-stance-table", "최상단 배포용 오프라인 엔진 서비스워커 존재");
