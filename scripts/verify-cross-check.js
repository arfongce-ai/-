...
assertContains(readUtf8(path.join(root, "www", "service-worker.js")), "poomsae-training-v18-final-correction", "www 직접 배포용 오프라인 엔진 캐시 적용");
...
assertContains(readUtf8(rootServiceWorkerPath), "poomsae-training-root-offline-engine-v16-final-correction", "최상단 배포용 오프라인 엔진 서비스워커 존재");
