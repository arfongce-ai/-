...
assertContains(webHtml, "data-jump=\"shoot\"", "빠른 이동 촬영 버튼 존재");
assertContains(webHtml, "data-jump=\"analyze\"", "빠른 이동 분석 버튼 존재");
...
assertContains(readUtf8(path.join(root, "www", "service-worker.js")), "poomsae-training-v98-shoot-analyze-nav", "www 직접 배포용 오프라인 엔진 캐시 적용");
...
assertContains(readUtf8(rootServiceWorkerPath), "poomsae-training-root-v30-shoot-analyze-nav", "최상단 배포용 오프라인 엔진 서비스워커 존재");
