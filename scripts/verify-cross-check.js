...
assertContains(webHtml, "태권도 품새 수련인을 위한 영상 기반 AI 분석 코치 · v3.27", "헤더 설명 문구 적용");
...
assertContains(webHtml, "duration * 3.5", "정밀 구간 감지를 초당 3.5회 수준으로 유지");
assertContains(webHtml, "duration * 0.7", "거친 스캔으로 정지 구간을 건너뛰는 2단계 탐색 적용");
...
assertContains(webHtml, "</div>\n        <img class=\"app-footer-partners\"", "새 로고를 위 로고와 제작 글 전체 아래에 표시");
assertContains(webHtml, "grid-column: 1 / -1", "아래 파트너 로고를 하단 전체 너비로 표시");
